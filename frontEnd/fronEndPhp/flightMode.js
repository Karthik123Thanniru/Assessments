$(document).ready(function() {
    $.ajax({
        url: "http://localhost/test/practiceTest/flightMode.php",
        dataType: "json",
    ...
    $("form").on("submit", function(e) {
        ...
        if (departureValue === destinationValue) {
            ...
            if (dateValue < currentTime) {
                ...
                $.ajax({
               url: "http://localhost/test/practiceTest/flightTraveller.php",
               method: "POST", 
               data: {
                ...
                function redirectWithData(response) {
                    ...
                    var redirectUrl = "flightTraveller.html?data=" + encodedUriComponent;
